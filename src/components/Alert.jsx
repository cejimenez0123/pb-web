...
>
  <div
    role="alert"
    className={`alert h-[6em] w-[96vw] md:w-page mx-auto ${success ? "alert-success" : "alert-warning"} animate-fade-out pointer-events-auto`}
  >
...
//       <div className='fixed top-8 left-0 right-0  w-[96vw]  mx-auto sm:w-page z-50 mx-auto'>
