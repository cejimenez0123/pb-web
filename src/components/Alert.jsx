...
export default function Alert(){
    ...
    return( error || success?       <div className='fixed top-4 left-0 right-0  w-[96vw]  mx-auto md:w-[60%]  z-50 mx-auto'>
    <div role="alert" className={`alert h-[6em]  w-[96vw]   ${success?"alert-success":"alert-warning"} animate-fade-out`}>
