...
function BookListItem({ book }) {
  ...
  return (
    <div
      onClick={navigateToBook}
      className="min-h-[10rem] min-w-[16rem] flex flex-col justify-between rounded-xl bg-base-bg border border-soft dark:border-purple cursor-pointer shadow-md mx-2 transition-shadow duration-300 p-4 space-y-3 active:scale-[0.98]"
