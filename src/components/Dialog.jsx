      ...
      {visible && (
        <>
          ...
          >
            <div
              style={{ height: `${dialog.height ?? 90}vh` }}
              className="bg-base-bg rounded-t-3xl shadow-xl px-4 pt-3 pb-8 flex flex-col"
            >
              {/* Grabber */}
              ...
              <div className="mt-6 flex gap-3 justify-end">
                {dialog.disagree && (
                  <button
                    onClick={() => { dialog.disagree(); handleClose(); }}
                    className="px-5 h-[3rem] rounded-full border border-soft bg-base-soft text-soft active:scale-95 transition"
