  ...
  return (
    ...
    >
      {book.storyIdList?.map((stc) => {
        ...
        return (
          <swiper-slide className="w-[100vw]" key={stc.id}>
            <div
              onTouchStartCapture={() => {
                sendGAEvent(
              ...
              className="flex-col flex overflow-clip w-[100vw] sm:max-w-[100%] sm:max-h-[40em]"
              id={stc.id}
            >
...
//       </div>)
//     }else{
        // return(<div className='skeleton min-h-[20em] rounded-box'/>)
//     }
// }