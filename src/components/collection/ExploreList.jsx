...
//     <h3 className="text-emerald-900 text-left bg-base-bg font-extrabold ml-16 lora-bold mb-4 text-2xl">
//       Explore
//     </h3>

//     <div className="mb-4">
//       <div className="flex min-h-[14rem] flex-row overflow-x-auto bg-base-bg overflow-y-clip h-[14rem] space-x-4 no-scrollbar">
