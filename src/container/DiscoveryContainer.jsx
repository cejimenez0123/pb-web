...
// import ListView from './page/ListView.jsx'
...
//         useEffect(()=>{
//             console.log("Cd",page)
//              setFilteredItems(items.slice(0,page*10).filter(item => item))
//         },[page])
//         // const filteredItems = viewItems.slice(0,page*10).filter(item => item);
//         const [hasMore,setHasMore]=useState(!items.length<filteredItems.length)
...
//                 <div className={`${isGrid ? "mx-auto" : "w-full md:w-page mx-auto"} overflow-x-hidden`}>
...
//                 </InfiniteScroll></div>)
//        }else{
// return <GridView viewItems={viewItems} />
//         }
//     }}
...
//     </Helmet>
//              <div className=' text-left  mt-4 max-w-[100vw] overflow-x-hidden' >
...
//                 <span className='flex flex-row  w-[100%] overflow-x-hidden md:w-page mx-auto  '>
...
//                         {/* <span className='flex my-auto flex-row'><button onClick={()=>onClickForGrid(true)}
...
//     {isGrid?<GridView viewItems={viewItems}/>:<ListView isGrid={isGrid} items={viewItems}/>}
