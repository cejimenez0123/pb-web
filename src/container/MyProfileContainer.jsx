...
//    <div role="tabpanel"    className="tab-content  pt-1 lg:py-4 rounded-lg    w-[96vw]  md:w-page mx-auto rounded-full">
...
//     />
//   <div role="tabpanel" 
//    className="tab-content  pt-1 lg:py-4 rounded-lg    w-[96vw]  md:w-page mx-auto rounded-full">
