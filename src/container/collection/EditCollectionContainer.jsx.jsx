        ...
        {loading ? (
          ...
          <div >
            ...
            <IonList lines="none">
              ...
              {/* Description */}
              {/* <IonItem className="rounded-l mb-4 border border-emerald-100"> */}
              ...
              {collection?.storyIdList?.length > 0 ? (
                <div className="space-y-2">
                  {collection.storyIdList.map((stc, i) => (
                    <div
                      key={i}
                      className="p-3 bg-emerald-50 rounded-lg flex justify-between items-center border border-emerald-100"
                    >
