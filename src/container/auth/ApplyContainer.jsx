    ...
    return(<>
        <div className=""> 
            <div>
                ...
                <div className="w-full text-center"><h1 className="mx-auto text-green-100 poppins w-fit">Interest Form</h1></div>
                <label className="input poppins mt-4 py-8 font-bold mb-8 lg:py-8 bg-dark border border-green-100  text-green-100 flex items-center gap-2">
  Preferred Name
...
<label className="input mt-4 poppins mb-8 font-bold  py-8 bg-dark border border-green-100 text-green-100  flex items-center gap-2">
  * E-mail
  <input type="text" className="grow text-green-100 pl-4 w-full" 
        ...
        placeholder='' />
                ...
                <label className="input poppins mt-4 mb-8 font-bold py-8 w-[100%] bg-dark border border-green-100 text-green-100 flex items-center gap-2">
  IG Handle
...
className="bg-dark border border-green-100 py-8 text-green-100 text-xl input"></input>
